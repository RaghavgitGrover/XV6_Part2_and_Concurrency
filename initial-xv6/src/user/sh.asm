...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2b058593          	addi	a1,a1,688 # 1310 <malloc+0xf4>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	27e50513          	addi	a0,a0,638 # 1318 <malloc+0xfc>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	35270713          	addi	a4,a4,850 # 1418 <malloc+0x1fc>
    ...
    panic("runcmd");
      ...
      e4:	24050513          	addi	a0,a0,576 # 1320 <malloc+0x104>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	22658593          	addi	a1,a1,550 # 1328 <malloc+0x10c>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	1ea58593          	addi	a1,a1,490 # 1338 <malloc+0x11c>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	16450513          	addi	a0,a0,356 # 1348 <malloc+0x12c>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	dccb8b93          	addi	s7,s7,-564 # 1370 <malloc+0x154>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	d9a50513          	addi	a0,a0,-614 # 1350 <malloc+0x134>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cda60613          	addi	a2,a2,-806 # 1378 <malloc+0x15c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	ccab0b13          	addi	s6,s6,-822 # 1398 <malloc+0x17c>
  ...
  return ret;
     ...
     70c:	c7850513          	addi	a0,a0,-904 # 1380 <malloc+0x164>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c1e50513          	addi	a0,a0,-994 # 1388 <malloc+0x16c>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	bfc60613          	addi	a2,a2,-1028 # 13a0 <malloc+0x184>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	b94a0a13          	addi	s4,s4,-1132 # 13a8 <malloc+0x18c>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	b6660613          	addi	a2,a2,-1178 # 13b0 <malloc+0x194>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	ac860613          	addi	a2,a2,-1336 # 1378 <malloc+0x15c>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	ae860613          	addi	a2,a2,-1304 # 13c8 <malloc+0x1ac>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	a9650513          	addi	a0,a0,-1386 # 13b8 <malloc+0x19c>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	a9e50513          	addi	a0,a0,-1378 # 13d0 <malloc+0x1b4>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	ad270713          	addi	a4,a4,-1326 # 1430 <malloc+0x214>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	8fe60613          	addi	a2,a2,-1794 # 1308 <malloc+0xec>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a56:	92e50513          	addi	a0,a0,-1746 # 1380 <malloc+0x164>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10da:	33a90913          	addi	s2,s2,826 # 1410 <malloc+0x1f4>
        while(*s != 0){
